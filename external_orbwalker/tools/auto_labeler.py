"""
tools/auto_labeler.py — Auto-anotação de screenshots usando o modelo treinado.
Usa o best.pt atual para gerar labels YOLO automaticamente nas novas imagens.
Uso: python tools/auto_labeler.py
"""
import os
import sys
import shutil
...
from config import BASE_DIR, VisionConfig
...
# Pasta onde ficam as screenshots novas ainda não anotadas
INBOX_DIR    = Path(BASE_DIR) / "dataset" / "inbox"
...
# Classes do YOLO (deve bater com lol_dataset.yaml)
CLASS_NAMES = {
    0: "enemy_champion",
    1: "enemy_minion",
    2: "enemy_turret",

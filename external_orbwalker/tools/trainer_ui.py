"""
tools/trainer_ui.py — Interface DearPyGui PRO para treinar modelos YOLOv8.
Exibe gráficos de evolução em tempo real, métricas detalhadas e log completo.
Uso: python tools/trainer_ui.py
"""
import threading
import subprocess
import os
...
from auto_labeler import process_inbox, get_inbox_images, print_dataset_stats, ensure_dirs, INBOX_DIR

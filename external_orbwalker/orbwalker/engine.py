        ...
        while self._running:
            ...
            if self.script and self.active:
                ...
                if self.use_vision and vision_target:
                    ...
                    self.humanizer.move_cursor_bezier(point.x, point.y, vision_target[0], vision_target[1], steps=10)
            ...
            if allow_aa and self.nextAttack < now:
                ...
                Keyboard.press_key(DIK_A, min_delay=0.005, max_delay=0.015)
                Mouse.mouse_click(Mouse.Buttons.Left, min_delay=0.005, max_delay=0.015)
